            ...
            <div class="col-md-8 blog-posts">
                <div class="blog-posts">
                    ...
                    <div class="blog-post mb-5" data-aos="fade-up" data-aos-duration="800" data-aos-delay="200">
                        <a href="{{ route('wedding') }}"><img data-src="images/weddings/low-angle-people-celebrating-wedding-nature.jpg" alt="Blog Post 1" class="img-fluid mb-3 lazyload"></a>
                        <div class="blog-post-meta small text-muted mb-2">
                            <span>Date</span> / <span>By Author</span>
                        </div>
                    ...
                    <div class="blog-post mb-5" data-aos="fade-up" data-aos-duration="800" data-aos-delay="200">
                        <a href="{{ route('arts') }}"><img data-src="images/acts/Untitled.jpeg" alt="Blog Post 1" class="img-fluid mb-3 lazyload"></a>
                        <div class="blog-post-meta small text-muted mb-2">
                            <span>Date</span> / <span>By Author</span>
                        </div>
                    ...
                    <div class="blog-post mb-5" data-aos="fade-up" data-aos-duration="800" data-aos-delay="200">
                        <a href="{{ route('dance') }}"><img data-src="images/dance/woman-recording-smartphone-video-club.jpg" alt="Blog Post 1" class="img-fluid mb-3 lazyload"></a>
                        <div class="blog-post-meta small text-muted mb-2">
                            <span>Date</span> / <span>By Author</span>
                        </div>
                    ...
                    <div class="blog-post mb-5" data-aos="fade-up" data-aos-duration="800" data-aos-delay="200">
                        <a href="{{ route('meditaion') }}"><img data-src="images/spiritual/full-shot-black-man-practising-yoga.jpg" alt="Blog Post 1" class="img-fluid mb-3 lazyload"></a>
                        <div class="blog-post-meta small text-muted mb-2">
                            <span>Date</span> / <span>By Author</span>
                        </div>
    ...
    <div class="footer-carousel-section" data-aos="fade-up" data-aos-duration="800" data-aos-delay="200">
        ...
        <div class="footer-carousel" data-aos="fade-up" data-aos-duration="800" data-aos-delay="200">
            <div class="carousel-container">
                ...
                <img data-src="images/weddings/lesbian-couple-celebrating-their-wedding-day-with-guests-friends.jpg" alt="Carousel Image 1" class="lazyload">
                <img data-src="images/dance.jpg" alt="Carousel Image 2" class="lazyload">
                <img data-src="images/meditation.jpg" alt="Carousel Image 3" class="lazyload">
                <img data-src="images/acts/close-up-woman-s-hand-painting-canvas-with-holding-messy-palette.jpg" alt="Carousel Image 4" class="lazyload">
                <img data-src="images/wedding.jpg" alt="Carousel Image 5" class="lazyload">
            </div>
